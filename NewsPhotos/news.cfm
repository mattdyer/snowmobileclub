<cfquery name="news" datasource="FSA1">
SELECT *
FROM news 
...
<div id="container">
  ...
  <div id="nav">
    ...
    <!--======================== BEGIN COPYING THE HTML HERE ==========================--><!-- #BeginLibraryItem "/Library/MainNav.lbi" --><div id="FWTableContainer1555515835">
...
<!-- Shim row, height 1. -->
  ...
  <tr><!-- row 1 -->
   ...
   <td><a href="news.cfm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('FSA_nav_r1_c7','','../images/FSA_nav_r1_c7_s2.gif',1)"><img name="FSA_nav_r1_c7" src="../images/FSA_nav_r1_c7.gif" width="91" height="22" border="0" alt="News & Events"></a></td>
...
</div><!-- #EndLibraryItem --><!--========================= STOP COPYING THE HTML HERE =========================-->
  </div>
  <div id="mainContent">
    <div class="floatL">
      <h1>News and Photos</h1>
    </div>
    <div id="currentNews">See our <a href="../newsletter/news.pdf">current news letter</a> </div> 
    <div class="clearing"></div>
<div id="slideshow"><script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','260','height','170','hspace','30','src','photoRndm','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','photoRndm' ); //end AC code
      </script>
      <noscript>
      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="260" height="170">
        <param name="movie" value="photoRndm.swf" />
        <param name="quality" value="high" />
        <embed src="photoRndm.swf" width="260" type="application/x-shockwave-flash" height="170" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash"></embed>
      </object>
    </noscript></div>
    
      <cfoutput query="news"> 
         <div class="NewsHeadline">#news.newsHeadline#</div><div id="NewsDate">#DateFormat(news.newsDate, "MMM D, YYYY")#</div>
          <div id="NewsDetail" >#news.newsDetails#</div>
      </cfoutput>
...
<tr>
                <td colspan="3" class="footerCtr" ><a href="../index.cfm">Home</a>&nbsp;|&nbsp;<a href="../mission.cfm">About</a>&nbsp;|&nbsp;<a href="../eventsCal.cfm">Calendar</a>&nbsp;|&nbsp;<a href="../ridingAreas.cfm">Riding</a>&nbsp;|&nbsp;<a href="../join.cfm">Join</a>&nbsp;|&nbsp;<a href="../localSvcs.cfm">Local Svcs</a>&nbsp;|&nbsp;<a href="news.cfm">News</a>&nbsp;|&nbsp;<a href="../links.cfm">Links</a>&nbsp;|&nbsp;<a href="../AdminWk/index.cfm">Admin</a></td>
              </tr>
