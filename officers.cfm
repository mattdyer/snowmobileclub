<cfquery name="officers" datasource="FSA1">
SELECT *
FROM officers 
</cfquery>
...
<div id="MMMenuContainer0228062045_1">
    ...
    <h1>Flathead Snowmobile Association Officers</h1>
    <table width="700" border="0" align="center" cellspacing="0" class="WADADataTable">
      <tr>
        <td class="TableHdrHoriz"><div align="left">Post</div></td>
        <td class="TableHdrHoriz"><div align="left">Name</div></td>
        <td class="TableHdrHoriz"><div align="left">Telephone</div></td>
        <td class="TableHdrHoriz"><div align="left">Email</div></td>
       </tr>
      <cfoutput query="officers" >
        <tr class="#WA_AltClassIterator_getClass(WARRT_AltClass1,true)#">
          <td class="WADADataTableCell">#officers.officerPost#</td>
          <td class="WADADataTableCell">#officers.FirstName# #officers.LastName#</td>
          <td class="WADADataTableCell">#officers.telephone#</td>
          <td class="WADADataTableCell"><a href="mailto:#officers.emailAddress#">#officers.emailAddress#</a></td>
        </tr>
      </cfoutput>
      <tr class="tableBtmBar">
        <td colspan="5" ><img src="" alt="" name="imgPlacehldr" width="1" height="14" id="imgPlacehldr" /></td>
      </tr>
    </table>
    <p>
      </p>
