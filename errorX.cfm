...
<title>Exception Error - Flathead Snowmobile Association</title>
<link href="http://www.flatheadsnowmobiler.com/FSA3.css" rel="stylesheet" type="text/css" />
<style type="text/css" media="screen">
@import url("http://www.flatheadsnowmobiler.com/FSA_nav.css");
</style>
<script language="JavaScript1.2" type="text/javascript" src="http://www.flatheadsnowmobiler.com/mm_css_menu.js"></script>
...
<link href="http://www.flatheadsnowmobiler.com/FSATxt.css" rel="stylesheet" type="text/css" />
</head>

<body class="oneColFixCtrHdr" onload="MM_preloadImages('http://flatheadsnowmobiler.com/images/FSA_nav_r2_c7_f2.jpg','images/FSA_nav_r1_c1_s2.gif','images/FSA_nav_r1_c2_s2.gif','images/FSA_nav_r1_c3_s2.gif','images/FSA_nav_r1_c4_s2.gif','images/FSA_nav_r1_c5_s2.gif','images/FSA_nav_r1_c6_s2.gif','images/FSA_nav_r1_c7_s2.gif','images/FSA_nav_r1_c9_s2.gif','images/FSA_nav_r1_c11_s2.gif')">
<div id="container">
  <div id="header"><img src="http://flatheadsnowmobiler.com/images/headerHome.jpg" width="955" alt="Flathead Snowmobile Association" height="110" />
    <!-- end #header -->
  </div>
...
<div id="mainContent">
    ...
    <div id="mainTable">
      <table width="63%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr><td><span class="msgTwo">Sorry. There was a problem with our page.
          </p>
        </span>
          <p class="headerSubTxt">The error has been emailed to the webmaster.</p></td>
        </tr>
          <td colspan="3"><cfoutput><span class="msgOne">#Error.Diagnostics#</span></cfoutput></td>
        </tr>
      </table>
    </div>
...
<!-- #EndLibraryItem --><p>&nbsp;</p>
  <!-- end #footer --></div>
<!-- end #container --></div>
<cfmail to="webmaster@gregmiller.biz" 
	from="webmaster@flatheadsnowmobiler.com" 
	subject="#APPLICATION.companyName# #ERROR.template#" type="html">
<cfmailpart type="html">
	<cfoutput><span class="bodyTxt">#Error.Diagnostics#</span></cfoutput>
  <p>
