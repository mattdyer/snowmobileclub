...
<div id="MMMenuContainer0228062045_1">
    ...
    <h1> Flathead Snowmobile Association's Mission</h1>
    <div id="MainImg">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
       	  <td width="52%"><div class="oneColFixCtrHdr">
   	        <div align="justify">The Flathead Snowmobile Association is a  membership of snowmobilers and outdoor enthusiasts who endeavor to educate the  public about the sport of snowmobiling, enhance the riding experience in our  area, promote safety, and provide opportunities for family recreation. </div>
       	  </div></td>
          <td width="48%"><div id="mainInsetImg"><img src="images/loneSled.jpg" alt="snowmobile" width="280" height="210" /></div></td>
      </tr>
        </table>
    </div>
