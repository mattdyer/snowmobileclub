<cfparam name="PageNum_Advertising" default="1">
<cfquery name="Advertising" datasource="FSA1">
SELECT *
FROM tblAds
WHERE AdsStartDate <= #Now()# AND AdsEndDate >= #Now()#
ORDER BY AdsPricePaid DESC
</cfquery>
<cfset MaxRows_Advertising=10>
<cfset StartRow_Advertising=Min((PageNum_Advertising-1)*MaxRows_Advertising+1,Max(Advertising.RecordCount,1))>
<cfset EndRow_Advertising=Min(StartRow_Advertising+MaxRows_Advertising-1,Advertising.RecordCount)>
<cfset TotalPages_Advertising=Ceiling(Advertising.RecordCount/MaxRows_Advertising)>
...
<br/>
<div id="weatherlinks"><script type="text/javascript" language="javascript1.2" src="http://weatherreports.com/jscript.html?width=125&height=125&theme=brand_no_search_box&location=Kalispell%2C%20MT&units=f">
</script><br/>
<script type="text/javascript" language="javascript1.2" src="http://weatherreports.com/jscript.html?width=125&height=125&theme=brand&location=59937&units=f">
    </script>
</div>

<table width="740" border="0" cellpadding="0" cellspacing="0" id="AdTable">
   <cfif Advertising.RecordCount eq 0>
   			<tr>
              <td colspan="3" valign="top"><img name="" src="" width="1" height="300" alt="Flathead Snowmobile Association" /></td>
            </tr>
            </cfif>
			<cfoutput query="Advertising" startRow="#StartRow_Advertising#" maxRows="#MaxRows_Advertising#">
        ...
        <tr>
          <td width="138" rowspan="2" valign="top" class="AdAddy"><a href="#Advertising.AdsLink#"><img src="images/#Advertising.AdsBanner#" alt="#Advertising.AdsCustomerName#" hspace="20" border="0"  /></a><br/>              </td>
          <td colspan="2" class="NewsHeadline">#Advertising.AdsHeadline#</td>
          </tr>
    <tr>
      <td colspan="2" valign="top" >
        <div class="adBodyTextTbl">
          <table border="1" cellspacing="0" cellpadding="0">
            <tr>
              <td class="adData">
                <cfif #Advertising.AdsAddress# NEQ "">#Advertising.AdsAddress#<br /></cfif><cfif #Advertising.AdsCity# NEQ "">#Advertising.AdsCity#  #Advertising.AdsState# #Advertising.AdsZip#<br/></cfif>
                <cfif #Advertising.AdsPhone# NEQ "">#Advertising.AdsPhone#<br /></cfif><cfif #Advertising.AdsEmail# NEQ ""><a href="mailto:#Advertising.AdsEmail#">#Advertising.AdsEmail#</a><br/></cfif><cfif #Advertising.AdsLink# NEQ ""><a href="#Advertising.AdsLink#" >#Advertising.AdsLink#</a></cfif></td>
      </tr>
          </table>
        </div>
        <div class="adBodyText">#Advertising.AdsBody#</div>        </td>
      </tr>
  </cfoutput>
</table>
<p><a href="http://fwp.mt.gov/parks/recreation/snomovendors.html" class="link1">Get Snowmobile Permits</a></p>
  <!-- end #mainContent --></div><!-- #BeginLibraryItem "/Library/footerNav.lbi" --><table width="100%" border="0" cellspacing="0" cellpadding="0">
