...
SELECT ID, userName, firstName, lastName FROM Users WHERE ID = <cfqueryparam value="#URL.ID#" cfsqltype="cf_sql_numeric"> 
</cfquery>
  ...
  <div id="mainContent"> <!-- InstanceBeginEditable name="Heading1" -->
    ...
    <div class="WADADeleteContainer">
      <cfif WADAUsers.RecordCount GT 0>
        <form action="Users_Delete.cfm?ID=<cfoutput>#URLEncodedFormat(WADAUsers.ID)#</cfoutput>" method="post" name="WADADeleteForm" id="WADADeleteForm">
          ...
          <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
            <tr>
              ...
              <td class="WADADataTableCell"><cfoutput>#WADAUsers.userName#</cfoutput></td>
            </tr>
            <tr>
              <th class="WADADataTableHeader">First Name:</th>
              <td class="WADADataTableCell"><cfoutput>#WADAUsers.firstName#</cfoutput></td>
            </tr>
            <tr>
              <th class="WADADataTableHeader">Last Name:</th>
              <td class="WADADataTableCell"><cfoutput>#WADAUsers.lastName#</cfoutput></td>
            </tr>
          </table>
          <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
          <div class="WADAButtonRow">
            ...
            <input name="WADADeleteRecordID" type="hidden" id="WADADeleteRecordID" value="<cfoutput>#URLEncodedFormat(WADAUsers.ID)#</cfoutput>" />
          </div>
        </form>
      </cfif>
