...
<cfparam name="PageNum_WADAtblAds" default="1">
<cfquery name="WADAtblAds" datasource="FSA1">
SELECT AdsID, AdsCustomerName, AdsHeadline, AdsBanner, AdsStartDate, AdsEndDate FROM tblAds ORDER BY AdsEndDate ASC 
</cfquery>
<cfset MaxRows_WADAtblAds=10>
<cfset StartRow_WADAtblAds=Min((PageNum_WADAtblAds-1)*MaxRows_WADAtblAds+1,Max(WADAtblAds.RecordCount,1))>
<cfset EndRow_WADAtblAds=Min(StartRow_WADAtblAds+MaxRows_WADAtblAds-1,WADAtblAds.RecordCount)>
<cfset TotalPages_WADAtblAds=Ceiling(WADAtblAds.RecordCount/MaxRows_WADAtblAds)>
<cfset QueryString_WADAtblAds=Iif(CGI.QUERY_STRING NEQ "",DE("&"&XMLFormat(CGI.QUERY_STRING)),DE(""))>
<cfset tempPos=ListContainsNoCase(QueryString_WADAtblAds,"PageNum_WADAtblAds=","&")>
<cfif tempPos NEQ 0>
  <cfset QueryString_WADAtblAds=ListDeleteAt(QueryString_WADAtblAds,tempPos,"&")>
</cfif>
              ...
              <cfif WADAtblAds.RecordCount GT 0>
                  <div class="WADAResults">
                    <div class="WADAResultsNavigation">
                      <div class="WADAResultsInsertButton"> <a href="tblAds_Insert.cfm" title="Insert"><img border="0" name="Insert" id="Insert" alt="Insert" src="../WA_DataAssist/images/Pacifica/Refined_insert.gif" /></a> </div>
                    </div>
                    <table class="WADAResultsTable" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <th class="WADAResultsTableHeader">Advertiser Name:</th>
                        <th class="WADAResultsTableHeader">Ad Headline:</th>
                        <th class="WADAResultsTableHeader"><div align="center">Start Date:</div></th>
                        <th class="WADAResultsTableHeader"><div align="center">End Date:</div></th>
                        <th>&nbsp;</th>
                      </tr>
                      <cfoutput query="WADAtblAds" startRow="#StartRow_WADAtblAds#" maxRows="#MaxRows_WADAtblAds#">
                        <tr class="#WA_AltClassIterator_getClass(WARRT_AltClass1,true)#">
                          <td class="WADAResultsTableCell">#WADAtblAds.AdsCustomerName#</td>
                          <td class="WADAResultsTableCell"><a href="tblAds_Detail.cfm?AdsID=#URLEncodedFormat(WADAtblAds.AdsID)#" >#WADAtblAds.AdsHeadline#</a></td>
                          <td class="WADAResultsTableCell"><div align="center">#DateFormat(WADAtblAds.AdsStartDate,"M/D/YY")#</div></td>
                         
                          <td class="WADAResultsTableCell"> <div align="center">
                            <cfif WADAtblAds.AdsEndDate LT Now()>
								<span class="expireSoon">Expired!</span><br/>
                              
							 <cfelseif WADAtblAds.AdsEndDate - Now() LTE 30>
                              <span class="expireSoon">Expiring Soon</span><br/>
                              
                            </cfif>
                            #DateFormat(WADAtblAds.AdsEndDate,"M/D/YY")#</div></td>
						  
                          <td class="WADAResultsEditButtons" nowrap="nowrap"><table class="WADAEditButton_Table">
                            <tr>
                              <td><a href="tblAds_Detail.cfm?AdsID=#URLEncodedFormat(WADAtblAds.AdsID)#" title="View"><img border="0" name="View#URLEncodedFormat(WADAtblAds.AdsID)#" id="View#URLEncodedFormat(WADAtblAds.AdsID)#" alt="View" src="../WA_DataAssist/images/Pacifica/Refined_zoom.gif" /></a></td>
                              <td><a href="tblAds_Update.cfm?AdsID=#URLEncodedFormat(WADAtblAds.AdsID)#" title="Update"><img border="0" name="Update#URLEncodedFormat(WADAtblAds.AdsID)#" id="Update#URLEncodedFormat(WADAtblAds.AdsID)#" alt="Update" src="../WA_DataAssist/images/Pacifica/Refined_edit.gif" /></a></td>
                              <td><a href="tblAds_Delete.cfm?AdsID=#URLEncodedFormat(WADAtblAds.AdsID)#" title="Delete"><img border="0" name="Delete#URLEncodedFormat(WADAtblAds.AdsID)#" id="Delete#URLEncodedFormat(WADAtblAds.AdsID)#" alt="Delete" src="../WA_DataAssist/images/Pacifica/Refined_trash.gif" /></a></td>
                            </tr>
                          </table></td>
                        </tr>
                      </cfoutput>
                    ...
                    <div class="WADAResultsNavigation">
                      <div class="WADAResultsCount">Records
                        <cfoutput>#StartRow_WADAtblAds#</cfoutput>
                        to
                        <cfoutput>#EndRow_WADAtblAds#</cfoutput>
                        of
                        <cfoutput>#WADAtblAds.RecordCount#</cfoutput>
                      </div>
                      <div class="WADAResultsNavBottom">
                        <table border="0" align="center" cellpadding="0" cellspacing="0" class="WADAResultsNavTable">
                          <tr valign="middle">
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblAds GT 1>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblAds=1#QueryString_WADAtblAds#</cfoutput>" title="First"><img border="0" name="First1" id="First1" alt="First" src="../WA_DataAssist/images/Pacifica/Refined_first.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblAds GT 1>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblAds=#Max(DecrementValue(PageNum_WADAtblAds),1)##QueryString_WADAtblAds#</cfoutput>" title="Previous"><img border="0" name="Previous1" id="Previous1" alt="Previous" src="../WA_DataAssist/images/Pacifica/Refined_previous.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblAds LT TotalPages_WADAtblAds>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblAds=#Min(IncrementValue(PageNum_WADAtblAds),TotalPages_WADAtblAds)##QueryString_WADAtblAds#</cfoutput>" title="Next"><img border="0" name="Next1" id="Next1" alt="Next" src="../WA_DataAssist/images/Pacifica/Refined_next.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblAds LT TotalPages_WADAtblAds>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblAds=#TotalPages_WADAtblAds##QueryString_WADAtblAds#</cfoutput>" title="Last"><img border="0" name="Last1" id="Last1" alt="Last" src="../WA_DataAssist/images/Pacifica/Refined_last.gif" /></a>
                            </cfif></td>
                          </tr>
                        </table>
                      </div>
                ...
                <cfif WADAtblAds.RecordCount EQ 0>
                  <div class="WADANoResults">
                    ...
                    <div> <a href="tblAds_Insert.cfm" title="Insert"><img border="0" name="Insert1" id="Insert1" alt="Insert" src="../WA_DataAssist/images/Pacifica/Refined_insert.gif" /></a> </div>
                  </div>
                </cfif>
            </div>
