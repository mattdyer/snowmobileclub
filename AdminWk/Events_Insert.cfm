...
<cfif (isDefined("Form.Insert.x")) >
  ...
  <cfset WA_insTable = "Events" />
  <cfset WA_sessionName = "WADA_Insert_Events" />
...
<!-- #EndLibraryItem --><!--========================= STOP COPYING THE HTML HERE =========================-->
  ...
  <div id="mainContent"> <!-- InstanceBeginEditable name="Heading1" --><h1>Add Events</h1><!-- InstanceEndEditable -->
      <div id="MainImg">
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <div class="WADAInsertContainer">
            <cfform action="Events_Insert.cfm" method="post" name="WADAInsertForm" id="WADAInsertForm">
              <div class="WADAHeader">Insert Record</div>
              <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
              <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <th class="WADADataTableHeader">Event Name:</th>
                  <td class="WADADataTableCell"><input type="text" name="eventName" id="eventName" value="" size="32" /></td>
                </tr>
                <tr>
                  <th class="WADADataTableHeader">Date:<br/>
                    <table width="180" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="tableHdrSubTxt">In order for the calendar page to sort properly, this entry must be in date format. Please use the calendar pop-up to set the starting date.</td>
                      </tr>
                    </table>
                    </th>
                  <td valign="top" class="WADADataTableCell"><cfinput type="datefield" name="eventDate" id="eventDate" value="" size="10" /></td>
                </tr>
                <tr>
                  <th class="WADADataTableHeader">Time:</th>
                  <td class="WADADataTableCell"><input type="text" name="eventTime" id="eventTime" value="" size="32" /></td>
                </tr>
                <tr>
                  <th class="WADADataTableHeader">Location:</th>
                  <td class="WADADataTableCell"><input type="text" name="eventLocation" id="eventLocation" value="" size="32" /></td>
                </tr>
                <tr>
                  <th class="WADADataTableHeader">Details:</th>
                  <td class="WADADataTableCell"><cftextarea name="eventNote" cols="32" rows="4" id="eventNote"></cftextarea></td>
                </tr>
              </table>
              <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
