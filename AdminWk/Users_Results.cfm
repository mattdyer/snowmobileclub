...
<cfparam name="PageNum_WADAUsers" default="1">
<cfquery name="WADAUsers" datasource="FSA1">
SELECT ID, firstName, lastName, userName, role, emailAddress FROM Users ORDER BY lastName ASC 
</cfquery>
<cfset MaxRows_WADAUsers=10>
<cfset StartRow_WADAUsers=Min((PageNum_WADAUsers-1)*MaxRows_WADAUsers+1,Max(WADAUsers.RecordCount,1))>
<cfset EndRow_WADAUsers=Min(StartRow_WADAUsers+MaxRows_WADAUsers-1,WADAUsers.RecordCount)>
<cfset TotalPages_WADAUsers=Ceiling(WADAUsers.RecordCount/MaxRows_WADAUsers)>
<cfset QueryString_WADAUsers=Iif(CGI.QUERY_STRING NEQ "",DE("&"&XMLFormat(CGI.QUERY_STRING)),DE(""))>
<cfset tempPos=ListContainsNoCase(QueryString_WADAUsers,"PageNum_WADAUsers=","&")>
<cfif tempPos NEQ 0>
  <cfset QueryString_WADAUsers=ListDeleteAt(QueryString_WADAUsers,tempPos,"&")>
</cfif>
...
<!-- #EndLibraryItem --><!--========================= STOP COPYING THE HTML HERE =========================-->
  ...
  <div id="mainContent"> <!-- InstanceBeginEditable name="Heading1" -->
    ...
    <div class="WADAResultsContainer"> <a name="top"></a>
      ...
      <cfif WADAUsers.RecordCount GT 0>
          <div class="WADAResults">
            <div class="WADAResultsNavigation">
              <div class="WADAResultsCount">Records
                <cfoutput>#StartRow_WADAUsers#</cfoutput>
                to
                <cfoutput>#EndRow_WADAUsers#</cfoutput>
                of
                <cfoutput>#WADAUsers.RecordCount#</cfoutput>
              </div>
              <div class="WADAResultsNavTop">
                <table border="0" cellpadding="0" cellspacing="0" class="WADAResultsNavTable">
                  <tr valign="middle">
                    <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAUsers GT 1>
                      <a href="<cfoutput>#CurrentPage#?PageNum_WADAUsers=1#QueryString_WADAUsers#</cfoutput>" title="First"><img border="0" name="First" id="First" alt="First" src="../WA_DataAssist/images/Pacifica/Refined_first.gif" /></a>
                    </cfif></td>
                    <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAUsers GT 1>
                      <a href="<cfoutput>#CurrentPage#?PageNum_WADAUsers=#Max(DecrementValue(PageNum_WADAUsers),1)##QueryString_WADAUsers#</cfoutput>" title="Previous"><img border="0" name="Previous" id="Previous" alt="Previous" src="../WA_DataAssist/images/Pacifica/Refined_previous.gif" /></a>
                    </cfif></td>
                    <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAUsers LT TotalPages_WADAUsers>
                      <a href="<cfoutput>#CurrentPage#?PageNum_WADAUsers=#Min(IncrementValue(PageNum_WADAUsers),TotalPages_WADAUsers)##QueryString_WADAUsers#</cfoutput>" title="Next"><img border="0" name="Next" id="Next" alt="Next" src="../WA_DataAssist/images/Pacifica/Refined_next.gif" /></a>
                    </cfif></td>
                    <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAUsers LT TotalPages_WADAUsers>
                      <a href="<cfoutput>#CurrentPage#?PageNum_WADAUsers=#TotalPages_WADAUsers##QueryString_WADAUsers#</cfoutput>" title="Last"><img border="0" name="Last" id="Last" alt="Last" src="../WA_DataAssist/images/Pacifica/Refined_last.gif" /></a>
                    </cfif></td>
                  </tr>
                </table>
              </div>
              <div class="WADAResultsInsertButton"> <a href="Users_Insert.cfm" title="Insert"><img border="0" name="Insert" id="Insert" alt="Insert" src="../WA_DataAssist/images/Pacifica/Refined_insert.gif" /></a> </div>
            </div>
            <table class="WADAResultsTable" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <th class="WADAResultsTableHeader">Email Address:</th>
                <th>&nbsp;</th>
              </tr>
              <cfoutput query="WADAUsers" startRow="#StartRow_WADAUsers#" maxRows="#MaxRows_WADAUsers#">
                <tr class="#WA_AltClassIterator_getClass(WARRT_AltClass1,true)#">
                  <td class="WADAResultsTableCell">#WADAUsers.firstName#</td>
                  <td class="WADAResultsTableCell">#WADAUsers.lastName#</td>
                  <td class="WADAResultsTableCell">#WADAUsers.userName#</td>
                  <td class="WADAResultsTableCell"><a href="mailto:#WADAUsers.emailAddress#">#WADAUsers.emailAddress#</a></td>
                  <td class="WADAResultsEditButtons" nowrap="nowrap"><table class="WADAEditButton_Table">
                    <tr>
                      <td><a href="Users_Update.cfm?ID=#URLEncodedFormat(WADAUsers.ID)#" title="Update"><img border="0" name="Update#URLEncodedFormat(WADAUsers.ID)#" id="Update#URLEncodedFormat(WADAUsers.ID)#" alt="Update" src="../WA_DataAssist/images/Pacifica/Refined_edit.gif" /></a></td>
                      <td><a href="Users_Delete.cfm?ID=#URLEncodedFormat(WADAUsers.ID)#" title="Delete"><img border="0" name="Delete#URLEncodedFormat(WADAUsers.ID)#" id="Delete#URLEncodedFormat(WADAUsers.ID)#" alt="Delete" src="../WA_DataAssist/images/Pacifica/Refined_trash.gif" /></a></td>
                    </tr>
                  </table></td>
                </tr>
              </cfoutput>
            ...
            <div class="WADAResultsNavigation">
              ...
              <div class="WADAResultsNavBottom">
                <table border="0" cellpadding="0" cellspacing="0" class="WADAResultsNavTable">
                  <tr valign="middle">
                    <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAUsers GT 1>
                      <a href="<cfoutput>#CurrentPage#?PageNum_WADAUsers=1#QueryString_WADAUsers#</cfoutput>" title="First"><img border="0" name="First1" id="First1" alt="First" src="../WA_DataAssist/images/Pacifica/Refined_first.gif" /></a>
                    </cfif></td>
                    <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAUsers GT 1>
                      <a href="<cfoutput>#CurrentPage#?PageNum_WADAUsers=#Max(DecrementValue(PageNum_WADAUsers),1)##QueryString_WADAUsers#</cfoutput>" title="Previous"><img border="0" name="Previous1" id="Previous1" alt="Previous" src="../WA_DataAssist/images/Pacifica/Refined_previous.gif" /></a>
                    </cfif></td>
                    <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAUsers LT TotalPages_WADAUsers>
                      <a href="<cfoutput>#CurrentPage#?PageNum_WADAUsers=#Min(IncrementValue(PageNum_WADAUsers),TotalPages_WADAUsers)##QueryString_WADAUsers#</cfoutput>" title="Next"><img border="0" name="Next1" id="Next1" alt="Next" src="../WA_DataAssist/images/Pacifica/Refined_next.gif" /></a>
                    </cfif></td>
                    <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAUsers LT TotalPages_WADAUsers>
                      <a href="<cfoutput>#CurrentPage#?PageNum_WADAUsers=#TotalPages_WADAUsers##QueryString_WADAUsers#</cfoutput>" title="Last"><img border="0" name="Last1" id="Last1" alt="Last" src="../WA_DataAssist/images/Pacifica/Refined_last.gif" /></a>
                    </cfif></td>
                  </tr>
                </table>
              </div>
        ...
        <cfif WADAUsers.RecordCount EQ 0>
          <div class="WADANoResults">
            <div class="WADANoResultsMessage">No results for your search</div>
            <div> <a href="Users_Insert.cfm" title="Insert"><img border="0" name="Insert1" id="Insert1" alt="Insert" src="../WA_DataAssist/images/Pacifica/Refined_insert.gif" /></a> </div>
          </div>
        </cfif>
    </div>
    <!-- InstanceEndEditable -->
