...
SELECT ID, officerPost, FirstName, LastName FROM officers WHERE ID = <cfqueryparam value="#URL.ID#" cfsqltype="cf_sql_numeric"> 
</cfquery>
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <div class="WADADeleteContainer">
              <cfif WADAofficers.RecordCount GT 0><form action="officers_Delete.cfm?ID=<cfoutput>#URLEncodedFormat(WADAofficers.ID)#</cfoutput>" method="post" name="WADADeleteForm" id="WADADeleteForm"><div class="WADAHeader"></div>
                  ...
                  <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      ...
                      <td class="WADADataTableCell"><cfoutput>#WADAofficers.officerPost#</cfoutput></td>
                    </tr>
                    <tr>
                      <th class="WADADataTableHeader">First Name:</th>
                      <td class="WADADataTableCell"><cfoutput>#WADAofficers.FirstName#</cfoutput></td>
                    </tr>
                    <tr>
                      <th class="WADADataTableHeader">Last Name:</th>
                      <td class="WADADataTableCell"><cfoutput>#WADAofficers.LastName#</cfoutput></td>
                    </tr>
                  </table>
                  <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                  <div class="WADAButtonRow">
                    ...
                    <input name="WADADeleteRecordID" type="hidden" id="WADADeleteRecordID" value="<cfoutput>#URLEncodedFormat(WADAofficers.ID)#</cfoutput>" />
                  </div>
                </form>
              </cfif>
