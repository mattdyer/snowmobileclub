...
<cfif IsDefined("FORM.MM_InsertRecord") AND FORM.MM_InsertRecord EQ "form1">
  <cfquery datasource="FSA1">   
    INSERT INTO Users (userName, pword, role, firstName, lastName, emailAddress)
...
<cfqueryparam value="#FORM.pword#" cfsqltype="cf_sql_clob" maxlength="255">
<cfelse>
''
</cfif>
, <cfif IsDefined("FORM.role") AND #FORM.role# NEQ "">
<cfqueryparam value="#FORM.role#" cfsqltype="cf_sql_clob" maxlength="255">
<cfelse>
''
</cfif>
, <cfif IsDefined("FORM.firstName") AND #FORM.firstName# NEQ "">
<cfqueryparam value="#FORM.firstName#" cfsqltype="cf_sql_clob" maxlength="255">
<cfelse>
''
</cfif>
, <cfif IsDefined("FORM.lastName") AND #FORM.lastName# NEQ "">
<cfqueryparam value="#FORM.lastName#" cfsqltype="cf_sql_clob" maxlength="255">
<cfelse>
''
</cfif>
, <cfif IsDefined("FORM.emailAddress") AND #FORM.emailAddress# NEQ "">
<cfqueryparam value="#FORM.emailAddress#" cfsqltype="cf_sql_clob" maxlength="255">
<cfelse>
''
</cfif>
)
  </cfquery>
  <cflocation url="userResults.cfm">
</cfif>
                ...
                <form action="<cfoutput>#CurrentPage#</cfoutput>" method="post" name="form1" id="form1">
                  <table align="center">
                    ...
                    <tr valign="baseline">
                      ...
                      <td><input type="password" name="pword" value="" size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                    ...
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">Emai lAddress:</td>
