...
<cfif (IIf(isDefined("Form.autologinoption"),"Form.autologinoption",DE("")) NEQ "") >
   <cfcookie name = "AutoLoginPWD" value = "#IIf(isDefined("Form.userpassword"),"Form.userpassword",DE(""))#" expires = "30" secure = "0" path = "/" domain = "" />
</cfif>
<cfif (IIf(isDefined("Form.autologinoption"),"Form.autologinoption",DE("")) NEQ "") >
   <cfcookie name = "AutoLoginUN" value = "#IIf(isDefined("Form.username"),"Form.username",DE(""))#" expires = "30" secure = "0" path = "/" domain = "" />
</cfif>
<cfif (IIf(isDefined("Form.remembermeoption"),"Form.remembermeoption",DE("")) NEQ "") >
   <cfcookie name = "RememberMePWD" value = "#IIf(isDefined("Form.userpassword"),"Form.userpassword",DE(""))#" expires = "30" secure = "0" path = "/" domain = "" />
</cfif>
<cfif (IIf(isDefined("Form.remembermeoption"),"Form.remembermeoption",DE("")) NEQ "") >
   <cfcookie name = "RememberMeUN" value = "#IIf(isDefined("Form.username"),"Form.username",DE(""))#" expires = "30" secure = "0" path = "/" domain = "" />
</cfif>
<cfif (IIf(isDefined("Form.username") AND NOT isDefined("Form.remembermeoption"),DE("1"),DE("")) NEQ "") >
   <cfcookie name = "RememberMePWD" value = "" expires = "30" secure = "0" path = "/" domain = "" />
</cfif>
<cfif (IIf(isDefined("Form.username") AND NOT isDefined("Form.remembermeoption"),DE("1"),DE("")) NEQ "") >
   <cfcookie name = "RememberMeUN" value = "" expires = "30" secure = "0" path = "/" domain = "" />
</cfif>
<cfif CGI.Request_Method EQ "POST" >
	<cfset WA_Auth_Parameter = StructNew() >
	<cfset WA_Auth_Parameter.connection = "FSA1" >
	<cfset WA_Auth_Parameter.tableName = "Users" >
	<cfset WA_Auth_Parameter.userName = "" >
	<cfset WA_Auth_Parameter.password = "" >
	<cfset WA_Auth_Parameter.columns = "userName"&WA_Auth_Separator&"pword" >
	<cfset WA_Auth_Parameter.columnValues = "" & ToString(IIf(isDefined("Form.username"),"Form.username",DE(""))) & ""&WA_Auth_Separator&"" & ToString(IIf(isDefined("Form.userpassword"),"Form.userpassword",DE(""))) & "" >
	<cfset WA_Auth_Parameter.columnTypes = "cf_sql_clob"&WA_Auth_Separator&"cf_sql_clob" >
	<cfset WA_Auth_Parameter.columnSizes = "7340148"&WA_Auth_Separator&"7340148" >
	<cfset WA_Auth_Parameter.sessionColumns = "ID" >
	<cfset WA_Auth_Parameter.sessionNames = "ID" >
	<cfset WA_Auth_Parameter.successRedirect = "Users_Profile.cfm" >
	<cfset WA_Auth_Parameter.failRedirect = "Users_EmailPW.cfm" >
	<cfset WA_Auth_Parameter.gotoPreviousURL = True >
	<cfset WA_Auth_Parameter.keepQueryString = True >
	
	<cfset WA_AuthenticateUser(WA_Auth_Parameter) >
</cfif>
<cfif IIf(isDefined("Cookie.AutoLoginUN"),"Cookie.AutoLoginUN",DE("")) NEQ "" AND IIf(isDefined("Cookie.AutoLoginPWD"),"Cookie.AutoLoginPWD",DE("")) NEQ "" >
	<cfset WA_Auth_Parameter = StructNew() >
	<cfset WA_Auth_Parameter.connection = "FSA1" >
	<cfset WA_Auth_Parameter.tableName = "Users" >
	<cfset WA_Auth_Parameter.userName = "" >
	<cfset WA_Auth_Parameter.password = "" >
	<cfset WA_Auth_Parameter.columns = "userName"&WA_Auth_Separator&"pword" >
	<cfset WA_Auth_Parameter.columnValues = "" & ToString(IIf(isDefined("Cookie.AutoLoginUN"),"Cookie.AutoLoginUN",DE(""))) & ""&WA_Auth_Separator&"" & ToString(IIf(isDefined("Cookie.AutoLoginPWD"),"Cookie.AutoLoginPWD",DE(""))) & "" >
	<cfset WA_Auth_Parameter.columnTypes = "cf_sql_clob"&WA_Auth_Separator&"cf_sql_clob" >
	<cfset WA_Auth_Parameter.columnSizes = "7340148"&WA_Auth_Separator&"7340148" >
	<cfset WA_Auth_Parameter.sessionColumns = "ID" >
	<cfset WA_Auth_Parameter.sessionNames = "ID" >
	<cfset WA_Auth_Parameter.successRedirect = "Users_Profile.cfm" >
	<cfset WA_Auth_Parameter.failRedirect = "" >
	<cfset WA_Auth_Parameter.gotoPreviousURL = True >
	<cfset WA_Auth_Parameter.keepQueryString = True >
...
<!-- #EndLibraryItem --><!--========================= STOP COPYING THE HTML HERE =========================-->
  ...
  <div id="mainContent"> <!-- InstanceBeginEditable name="Heading1" --><h1>Log In</h1><!-- InstanceEndEditable -->
      <div id="MainImg">
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <div id="LogInContainer" class="WAATK">
            <form action="<cfoutput>#GetFileFromPath(GetTemplatePath())#<cfif CGI.query_string NEQ "">?#CGI.query_string#</cfif></cfoutput>" method="post" name="WAATKLogInForm" id="WAATKLogInForm">
              <h1>&nbsp;</h1>
              <table class="WAATKDataTable" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <th>User name</th>
                  <td><input type="text" class="WAATKTextField" name="username" value="<cfoutput>#IIf(isDefined("Cookie.RememberMeUN"),"Cookie.RememberMeUN",DE(""))#</cfoutput>" /></td>
                </tr>
                <tr>
                  <th>Password</th>
                  <td><input type="password" class="WAATKTextField" name="userpassword" value="<cfoutput>#IIf(isDefined("Cookie.RememberMePWD"),"Cookie.RememberMeUN",DE(""))#</cfoutput>" /></td>
                </tr>
                <tr>
                  <th class="WAATKDataTableHeader"><input type="checkbox" name="remembermeoption" <cfoutput>#IIf(IsDefined("Cookie.RememberMeUN") and IsDefined("Cookie.RememberMePWD") and Cookie.RememberMeUN NEQ "" and Cookie.RememberMePWD NEQ "", DE("checked"), DE(""))#</cfoutput> /></th>
                  <td class="WAATKDataTableCell">Remember me</td>
                </tr>
                <tr>
                  <th class="WAATKDataTableHeader"><input type="checkbox" name="autologinoption"  /></th>
                  <td class="WAATKDataTableCell">Auto log in</td>
                </tr>
              </table>
              <div class="WAATKButtonRow">
                <input type="image" hspace="0" vspace="0" border="0" name="Log In" id="Log In" value="Log In" alt="Log In" src="../WA_SecurityAssist/images/Pacifica/Refined_login.gif"  />
              </div>
            </form>
          </div>
