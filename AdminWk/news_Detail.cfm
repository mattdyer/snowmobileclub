...
<cfparam name="WADA_URL_ID" default="#URL.ID#">
<cfparam name="SESSION.WADA_Insert_news" default="-1">
<cfquery name="WADAnews" datasource="FSA1">
SELECT ID, newsDate, newsHeadline, newsDetails FROM news WHERE ID = <cfqueryparam value="#URL.ID#" cfsqltype="cf_sql_numeric"> OR ( -1= <cfqueryparam value="#WADA_URL_ID#" cfsqltype="cf_sql_numeric"> AND ID=<cfqueryparam value="#SESSION.WADA_Insert_news#" cfsqltype="cf_sql_numeric">) 
</cfquery>
              ...
              <cfif WADAnews.RecordCount GT 0>
                  <div id="WADADetails">
                    ...
                    <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr>
                        ...
                        <td class="WADADataTableCell"><cfoutput>#WADAnews.newsDetails#</cfoutput></td>
                      </tr>
                    </table>
                    <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                    <div class="WADAButtonRow">
                      <table class="WADADataNavButtons" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="WADADataNavButtonCell" nowrap="nowrap"><a href="news_Update.cfm?ID=<cfoutput>#URLEncodedFormat(WADAnews.ID)#</cfoutput>" title="Update"><img border="0" name="Update" id="Update" alt="Update" src="../WA_DataAssist/images/Pacifica/Refined_update.gif" /></a></td>
                          <td class="WADADataNavButtonCell" nowrap="nowrap"><a href="news_Delete.cfm?ID=<cfoutput>#URLEncodedFormat(WADAnews.ID)#</cfoutput>" title="Delete"><img border="0" name="Delete" id="Delete" alt="Delete" src="../WA_DataAssist/images/Pacifica/Refined_delete.gif" /></a></td>
                          <td class="WADADataNavButtonCell" nowrap="nowrap"><a href="news_Results.cfm" title="Results"><img border="0" name="Results" id="Results" alt="Results" src="../WA_DataAssist/images/Pacifica/Refined_results.gif" /></a></td>
                        </tr>
                      </table>
                    </div>
                  </div>
                ...
                <cfif WADAnews.RecordCount EQ 0>
                  ...
                  <div class="WADADetailsLinkArea">
                    <div class="WADADataNavButtonCell"><a href="news_Results.cfm" title="Results"><img border="0" name="Results1" id="Results1" alt="Results" src="../WA_DataAssist/images/Pacifica/Refined_results.gif" /></a></div>
                  </div>
                  <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                </cfif>
            </div>
