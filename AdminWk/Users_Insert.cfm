...
<cfif (isDefined("Form.Insert.x")) >
  ...
  <cfset WA_insTable = "Users" />
  <cfset WA_sessionName = "WADA_Insert_Users" />
...
<!-- #EndLibraryItem --><!--========================= STOP COPYING THE HTML HERE =========================-->
  ...
  <div id="mainContent"> <!-- InstanceBeginEditable name="Heading1" -->
    ...
    <div class="WADAInsertContainer">
      <form action="Users_Insert.cfm" method="post" name="WADAInsertForm" id="WADAInsertForm">
        ...
        <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
          ...
          <tr>
            <th class="WADADataTableHeader">Pick a Username:</th>
            <td class="WADADataTableCell"><input type="text" name="userName" id="userName" value="" size="32" /></td>
          </tr>
          <tr>
            <th class="WADADataTableHeader">Choose a Password:</th>
            <td class="WADADataTableCell"><input type="password" name="pword" id="pword" value="" /></td>
          </tr>
<!---           <tr>
            <th class="WADADataTableHeader">Role:</th>
            <td class="WADADataTableCell"><input type="text" name="role" id="role" value="" size="32" /></td>
          </tr> --->

          <tr>
            <th class="WADADataTableHeader">Email Address:</th>
            <td class="WADADataTableCell"><input type="text" name="emailAddress" id="emailAddress" value="" size="32" /></td>
          </tr>
        </table>
        <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
