...
SELECT ID, officerPost, FirstName, LastName, telephone, emailAddress FROM officers WHERE ID = <cfqueryparam value="#URL.ID#" cfsqltype="cf_sql_numeric"> 
</cfquery>
<cfif (isDefined("Form.Update.x")) >
  <cfset WA_connection = "FSA1" />
  <cfset WA_table = "officers" />
  <cfset WA_redirectURL = "officers_Results.cfm" />
  <cfset WA_keepQueryString = false >
  <cfset WA_indexField = "ID" />
  <cfset WA_fieldNamesStr = "officerPost|FirstName|LastName|telephone|emailAddress" />
  <cfset WA_fieldValuesStr = "" & ToString(IIf(isDefined("Form.officerPost"),"Form.officerPost",DE(""))) & "" & "|" & "" & ToString(IIf(isDefined("Form.FirstName"),"Form.FirstName",DE(""))) & "" & "|" & "" & ToString(IIf(isDefined("Form.LastName"),"Form.LastName",DE(""))) & "" & "|" & "" & ToString(IIf(isDefined("Form.telephone"),"Form.telephone",DE(""))) & "" & "|" & "" & ToString(IIf(isDefined("Form.emailAddress"),"Form.emailAddress",DE(""))) & "" />
  <cfset WA_columnTypesStr = "',none,''|',none,''|',none,''|',none,''|',none,''" />
  <cfset WA_comparisonStr = " LIKE | LIKE | LIKE | LIKE | LIKE " />
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <div class="WADAUpdateContainer">
              <cfif WADAofficers.RecordCount GT 0><form action="officers_Update.cfm?ID=<cfoutput>#URLEncodedFormat(WADAofficers.ID)#</cfoutput>" method="post" name="WADAUpdateForm" id="WADAUpdateForm"><div class="WADAHeader"></div>
                  <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                  <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <th class="WADADataTableHeader">Post:</th>
                      <td class="WADADataTableCell"><input type="text" name="officerPost" id="officerPost" value="<cfoutput>#Replace(WADAofficers.officerPost, '"' , '&quot;', 'all')#</cfoutput>" size="32" /></td>
                    </tr>
                    <tr>
                      <th class="WADADataTableHeader">First Name:</th>
                      <td class="WADADataTableCell"><input type="text" name="FirstName" id="FirstName" value="<cfoutput>#Replace(WADAofficers.FirstName, '"' , '&quot;', 'all')#</cfoutput>" size="32" /></td>
                    </tr>
                    <tr>
                      <th class="WADADataTableHeader">Last Name:</th>
                      <td class="WADADataTableCell"><input type="text" name="LastName" id="LastName" value="<cfoutput>#Replace(WADAofficers.LastName, '"' , '&quot;', 'all')#</cfoutput>" size="32" /></td>
                    </tr>
                    <tr>
                      <th class="WADADataTableHeader">Telephone:</th>
                      <td class="WADADataTableCell"><input type="text" name="telephone" id="telephone" value="<cfoutput>#Replace(WADAofficers.telephone, '"' , '&quot;', 'all')#</cfoutput>" size="32" /></td>
                    </tr>
                    <tr>
                      <th class="WADADataTableHeader">Email:</th>
                      <td class="WADADataTableCell"><input type="text" name="emailAddress" id="emailAddress" value="<cfoutput>#Replace(WADAofficers.emailAddress, '"' , '&quot;', 'all')#</cfoutput>" size="32" /></td>
                    </tr>
                  </table>
                  <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                  <div class="WADAButtonRow">
                    <table class="WADADataNavButtons" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="WADADataNavButtonCell" nowrap="nowrap"><a href="officers_Results.cfm" title="Cancel"><img border="0" name="Cancel" id="Cancel" alt="Cancel" src="../WA_DataAssist/images/Pacifica/Refined_cancel.gif" /></a></td>
                      </tr>
                    </table>
                    <input name="WADAUpdateRecordID" type="hidden" id="WADAUpdateRecordID" value="<cfoutput>#URLEncodedFormat(WADAofficers.ID)#</cfoutput>" />
                  </div>
                </form>
              </cfif>
