...
<cfif (isDefined("Form.Send.x"))>
	<cfset WA_Auth_Parameter = StructNew() >
	<cfset WA_Auth_Parameter.connection = "FSA1" >
	<cfset WA_Auth_Parameter.tableName = "Users" >
	<cfset WA_Auth_Parameter.dbUserName = "" >
	<cfset WA_Auth_Parameter.dbPassword = "" >	
	<cfset WA_Auth_Parameter.column = "emailAddress" >
	<cfset WA_Auth_Parameter.columnValue = "IIf(isDefined(""Form.emailAddress""),""Form.emailAddress"",DE("")) NEQ """ >
	<cfset WA_Auth_Parameter.columnType = "cf_sql_clob" >
	<cfset WA_Auth_Parameter.columnSize = "-2147483647" >
	<cfset WA_Auth_Parameter.usernameColumn = "userName" >
	<cfset WA_Auth_Parameter.passwordColumn = "pword" >
	<cfset WA_Auth_Parameter.selectColumns = "" >
	<cfset WA_Auth_Parameter.sessionVariables = "" >
	<cfset WA_Auth_Parameter.successRedirect = "Users_LogIn.cfm" >
	<cfset WA_Auth_Parameter.failRedirect = "Users_EmailPW.cfm" >
	<cfset WA_Auth_Parameter.keepQueryString = True >
	<cfset WA_Auth_Parameter.emailSettings = "mail.flatheadsnowmobiler.com"&WA_Auth_Separator&"mailadmin@flatheadsnowmobiler.com"&WA_Auth_Separator&"nautica"&WA_Auth_Separator&""&WA_Auth_Separator&"" >
	<cfset WA_Auth_Parameter.toAddressColumn = "emailAddress" >
	<cfset WA_Auth_Parameter.fromAddress = "webmaster@flatheadsnowmobiler.com" >
	<cfset WA_Auth_Parameter.fromAddressDisplay = "FSA Webmaster" >
	<cfset WA_Auth_Parameter.subject = "Login Info" >
	<cfset WA_Auth_Parameter.mailBody = "User name: [userName]\nPassword: [pword]" >

	<cfset WA_Auth_ForgotPassword(WA_Auth_Parameter) >
</cfif>
...
<!-- #EndLibraryItem --><!--========================= STOP COPYING THE HTML HERE =========================-->
  ...
  <div id="mainContent"> <!-- InstanceBeginEditable name="Heading1" --><h1>Forgot Password</h1><!-- InstanceEndEditable -->
      <div id="MainImg">
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <div id="ForgotPWContainer" class="WAATK">
            <form action="Users_EmailPW.cfm" method="post" name="WAATKForgotPWForm" id="WAATKForgotPWForm">
              <h1>&nbsp;</h1>
              ...
              <div class="WAATKButtonRow">
                <input type="image" hspace="0" vspace="0" border="0" name="Send" id="Send" value="Send" alt="Send" src="../WA_SecurityAssist/images/Pacifica/Refined_send.gif"  />
              </div>
            </form>
          </div>
