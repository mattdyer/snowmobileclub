<cfparam name="SESSION.Auth.EmployeeID" default="">
...
<!--- If a AdsBanner image was selected for upload--->
...
<!--- Insert a record in the images table, write the filename and ProductID --->
<cfquery datasource="#APPLICATION.datasource#" name="addImg">
	INSERT INTO tblAds (AdsCustomerName, AdsHeadline, AdsBody, AdsBanner, AdsLink, AdsStartDate, AdsEndDate, AdsAddress, AdsCity, AdsState, AdsZip, AdsPhone, AdsEmail, AdsPricePaid)
	VALUES ('#FORM.AdsCustomerName#','#FORM.AdsHeadline#','#FORM.AdsBody#','#Filename_Photo1#','#FORM.AdsLink#','#FORM.AdsStartDate#','#FORM.AdsEndDate#', '#FORM.AdsAddress#', '#FORM.AdsCity#', '#FORM.AdsState#', '#FORM.AdsZip#', '#FORM.AdsPhone#', '#FORM.AdsEmail#', #FORM.AdsPricePaid#)
</cfquery>
<cfquery datasource="#APPLICATION.datasource#" name="GetNew">
SELECT Max(AdsID) as NewID
FROM tblAds
</cfquery>
<cflocation url="tblAds_Detail.cfm?AdsID=#GetNew.NewID#" addtoken="no">
</cfif>
<!--- <cfquery name="upDateThumb" datasource="#APPLICATION.datasource#">
SELECT AdsBanner 
FROM tblAds
...
UPDATE tblProducts 
SET ImageThm = '#upDateThumb.Imagefilename#'
WHERE ProductID = #FORM.ProductID#
</cfquery> --->
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <div class="WADAInsertContainer">
              <cfform action="tblAds_Insert.cfm" method="post" enctype="multipart/form-data" name="WADAInsertForm" id="WADAInsertForm">
                <div class="WADAHeader"></div>
                <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <th width="146" class="WADADataTableHeader">Advertiser Name:</th>
                    <td class="WADADataTableCell"><input type="text" name="AdsCustomerName" id="AdsCustomerName" value="" size="32" /></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Advertiser Price Paid:</th>
                    <td class="WADADataTableCell"><cfinput type="text" name="AdsPricePaid" id="AdsPricePaid" size="10" mask="9??????"/><span class="adBodyText">Annual rate.<br/>Ads on the Local Services page are sorted by price paid.</span></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Advertiser Address:</th>
                    <td class="WADADataTableCell"><input type="text" name="AdsAddress" id="AdsAddress" size="32"/></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">City</th>
                    <td class="WADADataTableCell"><input name="AdsCity" id="AdsCity" type="text" size="32" /></td>
                  </tr>
                  <tr>
                    ...
                    <td class="WADADataTableCellNoPad"><table border="0" align="left" cellpadding="0" cellspacing="0">
                      <tr class="WADADataTable">
                        <td class="WADADataTableCell"><input type="text" name="AdsState" id="AdsState" value="MT" size="6" /></td>
                        <td class="WADADataTableCell"><div align="right"><strong>Zip:</strong></div></td>
                        <td class="WADADataTableCell"><input type="text" name="AdsZip" id="AdsZip" size="10" /></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Ad Headline:</th>
                    <td class="WADADataTableCell"><input type="text" name="AdsHeadline" id="AdsHeadline" value="" size="32" /></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Ad Body Text:</th>
                    <td class="WADADataTableCell"><cftextarea name="AdsBody" cols="60"  rows="4"></cftextarea></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Ad Banner Image:</th>
                    <td class="WADADataTableCell"><input type="file" name="AdsBanner" id="AdsBanner" value="" size="20" /><br/>
					<span class="adBodyText">The image you are uploading must be less than 500k in size or the server will time out.<br/>
					After clicking the Insert button, you will not see a progress indicator. Please be patient.<br/>If you navigate away from this page or close this page prematurely, your upload will be interrupted.<br />When the upload completes, you will automatically be taken to the Ad Detail page.
                    </span></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Contact Email:</th>
                    <td class="WADADataTableCell"><input type="text" name="AdsEmail" id="AdsEmail" size="32"/></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader"> Web Link:</th>
                    <td class="WADADataTableCell"><input type="text" name="AdsLink" id="AdsLink" value="http://www." size="32" /></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader"> Contact Telephone:</th>
                    <td class="WADADataTableCell"><input type="text" name="AdsPhone" id="AdsPhone" size="32" />
                    <br />
                    888-555-1212</td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Start Date:</th>
                    <td class="WADADataTableCell"><cfinput type="datefield" name="AdsStartDate" id="AdsStartDate" value=""  required="yes" message="You must choose a start date for the ad." />
                      <br/>
                      <br/>
                      <br/></td>
                  </tr>
                  <tr>
                    ...
                    <td class="WADADataTableCell"><cfinput type="datefield" name="AdsEndDate" id="AdsEndDate" value="" required="yes" message="You must choose an end date for the ad." />
                      <br/>
                      <br/>
                      <br/></td>
                  </tr>
