...
<cfparam name="PageNum_WADAEvents" default="1">
<cfquery name="WADAEvents" datasource="FSA1">
SELECT ID, eventName, eventDate, eventTime, eventLocation, eventNote FROM Events ORDER BY eventDate ASC 
</cfquery>
<cfset MaxRows_WADAEvents=20>
<cfset StartRow_WADAEvents=Min((PageNum_WADAEvents-1)*MaxRows_WADAEvents+1,Max(WADAEvents.RecordCount,1))>
<cfset EndRow_WADAEvents=Min(StartRow_WADAEvents+MaxRows_WADAEvents-1,WADAEvents.RecordCount)>
<cfset TotalPages_WADAEvents=Ceiling(WADAEvents.RecordCount/MaxRows_WADAEvents)>
<cfset QueryString_WADAEvents=Iif(CGI.QUERY_STRING NEQ "",DE("&"&XMLFormat(CGI.QUERY_STRING)),DE(""))>
<cfset tempPos=ListContainsNoCase(QueryString_WADAEvents,"PageNum_WADAEvents=","&")>
<cfif tempPos NEQ 0>
  <cfset QueryString_WADAEvents=ListDeleteAt(QueryString_WADAEvents,tempPos,"&")>
</cfif>
<cfscript>
...
<!-- #EndLibraryItem --><!--========================= STOP COPYING THE HTML HERE =========================-->
  ...
  <div id="mainContent"> <!-- InstanceBeginEditable name="Heading1" --><h1>Events List</h1><!-- InstanceEndEditable -->
      <div id="MainImg">
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <div class="WADAResultsContainer"> <a name="top"></a>
            ...
            <cfif WADAEvents.RecordCount GT 0>
                <div class="WADAResults">
                  <div class="WADAResultsNavigation">
                    <div class="WADAResultsCount">Records
                      <cfoutput>#StartRow_WADAEvents#</cfoutput>
                      to
                      <cfoutput>#EndRow_WADAEvents#</cfoutput>
                      of
                      <cfoutput>#WADAEvents.RecordCount#</cfoutput>
                    </div>
                    <div class="WADAResultsNavTop">
                      <table border="0" cellpadding="0" cellspacing="0" class="WADAResultsNavTable">
                        <tr valign="middle">
                          <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAEvents GT 1>
                            <a href="<cfoutput>#CurrentPage#?PageNum_WADAEvents=1#QueryString_WADAEvents#</cfoutput>" title="First"><img border="0" name="First" id="First" alt="First" src="../WA_DataAssist/images/Pacifica/Refined_first.gif" /></a>
                          </cfif></td>
                          <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAEvents GT 1>
                            <a href="<cfoutput>#CurrentPage#?PageNum_WADAEvents=#Max(DecrementValue(PageNum_WADAEvents),1)##QueryString_WADAEvents#</cfoutput>" title="Previous"><img border="0" name="Previous" id="Previous" alt="Previous" src="../WA_DataAssist/images/Pacifica/Refined_previous.gif" /></a>
                          </cfif></td>
                          <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAEvents LT TotalPages_WADAEvents>
                            <a href="<cfoutput>#CurrentPage#?PageNum_WADAEvents=#Min(IncrementValue(PageNum_WADAEvents),TotalPages_WADAEvents)##QueryString_WADAEvents#</cfoutput>" title="Next"><img border="0" name="Next" id="Next" alt="Next" src="../WA_DataAssist/images/Pacifica/Refined_next.gif" /></a>
                          </cfif></td>
                          <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAEvents LT TotalPages_WADAEvents>
                            <a href="<cfoutput>#CurrentPage#?PageNum_WADAEvents=#TotalPages_WADAEvents##QueryString_WADAEvents#</cfoutput>" title="Last"><img border="0" name="Last" id="Last" alt="Last" src="../WA_DataAssist/images/Pacifica/Refined_last.gif" /></a>
                          </cfif></td>
                        </tr>
                      </table>
                    </div>
                    <div class="WADAResultsInsertButton"> <a href="Events_Insert.cfm" title="Insert"><img border="0" name="Insert" id="Insert" alt="Insert" src="../WA_DataAssist/images/Pacifica/Refined_insert.gif" /></a> </div>
                  </div>
                  <table class="WADAResultsTable" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <th class="WADAResultsTableHeader">Event Name:</th>
                      <th class="WADAResultsTableHeader">Location:</th>
                      <th class="WADAResultsTableHeader" >Date:</th>
                      <th width="40" class="WADAResultsTableHeader">Time:</th>
                      <th class="WADAResultsTableHeader">Details:</th>
                      <th>&nbsp;</th>
                    </tr>
                    <cfoutput query="WADAEvents" startRow="#StartRow_WADAEvents#" maxRows="#MaxRows_WADAEvents#">
                      <tr class="#WA_AltClassIterator_getClass(WARRT_AltClass1,true)#">
                        <td class="WADAResultsTableCell">#WADAEvents.eventName#</td>
                        <td class="WADAResultsTableCell">#WADAEvents.eventLocation#</td>
                        <td class="WADAResultsTableCell">#DateFormat(WADAEvents.eventDate,"MM/DD/YYYY")#</td>
                        <td class="WADAResultsTableCell">#WADAEvents.eventTime#</td>
                        <td class="WADAResultsTableCell">#WADAEvents.eventNote#</td>
                        <td class="WADAResultsEditButtons" nowrap="nowrap"><table class="WADAEditButton_Table">
                          <tr>
                            <td><a href="Events_Update.cfm?ID=#URLEncodedFormat(WADAEvents.ID)#" title="Update"><img border="0" name="Update#URLEncodedFormat(WADAEvents.ID)#" id="Update#URLEncodedFormat(WADAEvents.ID)#" alt="Update" src="../WA_DataAssist/images/Pacifica/Refined_edit.gif" /></a></td>
                            <td><a href="Events_Delete.cfm?ID=#URLEncodedFormat(WADAEvents.ID)#" title="Delete"><img border="0" name="Delete#URLEncodedFormat(WADAEvents.ID)#" id="Delete#URLEncodedFormat(WADAEvents.ID)#" alt="Delete" src="../WA_DataAssist/images/Pacifica/Refined_trash.gif" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                    </cfoutput>
                  ...
                  <div class="WADAResultsNavigation">
                    ...
                    <div class="WADAResultsNavBottom">
                      <table border="0" cellpadding="0" cellspacing="0" class="WADAResultsNavTable">
                        <tr valign="middle">
                          <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAEvents GT 1>
                            <a href="<cfoutput>#CurrentPage#?PageNum_WADAEvents=1#QueryString_WADAEvents#</cfoutput>" title="First"><img border="0" name="First1" id="First1" alt="First" src="../WA_DataAssist/images/Pacifica/Refined_first.gif" /></a>
                          </cfif></td>
                          <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAEvents GT 1>
                            <a href="<cfoutput>#CurrentPage#?PageNum_WADAEvents=#Max(DecrementValue(PageNum_WADAEvents),1)##QueryString_WADAEvents#</cfoutput>" title="Previous"><img border="0" name="Previous1" id="Previous1" alt="Previous" src="../WA_DataAssist/images/Pacifica/Refined_previous.gif" /></a>
                          </cfif></td>
                          <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAEvents LT TotalPages_WADAEvents>
                            <a href="<cfoutput>#CurrentPage#?PageNum_WADAEvents=#Min(IncrementValue(PageNum_WADAEvents),TotalPages_WADAEvents)##QueryString_WADAEvents#</cfoutput>" title="Next"><img border="0" name="Next1" id="Next1" alt="Next" src="../WA_DataAssist/images/Pacifica/Refined_next.gif" /></a>
                          </cfif></td>
                          <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAEvents LT TotalPages_WADAEvents>
                            <a href="<cfoutput>#CurrentPage#?PageNum_WADAEvents=#TotalPages_WADAEvents##QueryString_WADAEvents#</cfoutput>" title="Last"><img border="0" name="Last1" id="Last1" alt="Last" src="../WA_DataAssist/images/Pacifica/Refined_last.gif" /></a>
                          </cfif></td>
                        </tr>
                      </table>
                    </div>
              ...
              <cfif WADAEvents.RecordCount EQ 0>
                <div class="WADANoResults">
                  <div class="WADANoResultsMessage">No results for your search</div>
                  <div> <a href="Events_Insert.cfm" title="Insert"><img border="0" name="Insert1" id="Insert1" alt="Insert" src="../WA_DataAssist/images/Pacifica/Refined_insert.gif" /></a> </div>
                </div>
              </cfif>
          </div>
