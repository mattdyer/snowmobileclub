...
SELECT linkID, linkURL, linkDesc FROM tblLinks WHERE linkID = <cfqueryparam value="#URL.linkID#" cfsqltype="cf_sql_numeric"> 
</cfquery>
          ...
          <tr>
            ...
            <div class="WADADeleteContainer">
              <cfif WADAtblLinks.RecordCount GT 0>
                <form action="tblLinks_Delete.cfm?linkID=<cfoutput>#URLEncodedFormat(WADAtblLinks.linkID)#</cfoutput>" method="post" name="WADADeleteForm" id="WADADeleteForm">
                  ...
                  <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      ...
                      <td class="WADADataTableCell"><cfoutput>#WADAtblLinks.linkURL#</cfoutput></td>
                    </tr>
                    <tr>
                  ...
                  <div class="WADAButtonRow">
                    ...
                    <input name="WADADeleteRecordID" type="hidden" id="WADADeleteRecordID" value="<cfoutput>#URLEncodedFormat(WADAtblLinks.linkID)#</cfoutput>" />
                  </div>
                </form>
              </cfif>
