...
<!--- If submitting, include check code. --->
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<cfform action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="LoginForm" method="POST">
        <!--- Make the email and passwords fields required --->
		<input name="userName_required" type="hidden" value="" />
		<input name="Userpword_required" type="hidden" value="" />
<div class="oneColFixCtrHdr">
        <h5 align="center" class="eC_CheckoutFormHeader">You must login to view this page. </h5>
        
		<table width="371" border="0"  cellpadding="0" cellspacing="0" class="WADAResultsTable">
		  <tr>
		  ...
		  <tr>
		    <td width="119" class="WADAResultsTableHeader"><label for="Username">Username</label></td>
              <td colspan="3" align="left" class="WADAResultsTableCell" ><cfinput name="userName" type="text" size="40" maxlength="50" required="yes" message="Please enter your user name."/></td>
            </tr>
		  <tr>
		    <td class="WADAResultsTableHeader" ><label for="Userpword">Password</label></td>
              <td colspan="3"  align="left" class="WADAResultsTableCell"><cfinput name="Userpword" type="password" size="14" maxlength="14" required="yes" message="Please enter your password."/>
