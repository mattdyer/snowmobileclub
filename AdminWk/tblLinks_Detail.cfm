...
<cfparam name="WADA_URL_linkID" default="#URL.linkID#">
<cfparam name="SESSION.WADA_Insert_tblLinks" default="-1">
<cfquery name="WADAtblLinks" datasource="FSA1">
SELECT linkID, topic, linkURL, linkDesc, entryDate, lastDate, expDate FROM tblLinks WHERE linkID = <cfqueryparam value="#URL.linkID#" cfsqltype="cf_sql_numeric"> OR ( -1= <cfqueryparam value="#WADA_URL_linkID#" cfsqltype="cf_sql_numeric"> AND linkID=<cfqueryparam value="#SESSION.WADA_Insert_tblLinks#" cfsqltype="cf_sql_numeric">) 
</cfquery>
              ...
              <cfif WADAtblLinks.RecordCount GT 0>
                  <div id="WADADetails">
                    ...
                    <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td class="WADADataTableCell"><cfoutput>#WADAtblLinks.topic#</cfoutput></td>
                      </tr>
                      <tr>
                        <th class="WADADataTableHeader">URL:</th>
                        <td class="WADADataTableCell"><a href="<cfoutput>#WADAtblLinks.linkURL#</cfoutput>"><cfoutput>#WADAtblLinks.linkURL#</cfoutput></a></td>
                      </tr>
                      <tr>
                        <th class="WADADataTableHeader">Desc:</th>
                        <td class="WADADataTableCell"><cfoutput>#WADAtblLinks.linkDesc#</cfoutput></td>
                      </tr>
                      <tr>
                        <th class="WADADataTableHeader">Entered Date:</th>
                        <td class="WADADataTableCell"><cfoutput>#Dateformat(WADAtblLinks.entryDate,"MM/DD/YYYY")#</cfoutput></td>
                      </tr>
                      <tr>
                        <th class="WADADataTableHeader">Last Updated Date:</th>
                        <td class="WADADataTableCell"><cfoutput>#Dateformat(WADAtblLinks.lastDate,"MM/DD/YYYY")#</cfoutput></td>
                      </tr>
                      <tr>
                        <th class="WADADataTableHeader">Expiration Date:</th>
                        <td class="WADADataTableCell"><cfoutput>#Dateformat(WADAtblLinks.expDate,"MM/DD/YYYY")#</cfoutput></td>
                      </tr>
                    </table>
                    <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                    <div class="WADAButtonRow">
                      <table class="WADADataNavButtons" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="WADADataNavButtonCell" nowrap="nowrap"><a href="tblLinks_Update.cfm?linkID=<cfoutput>#URLEncodedFormat(WADAtblLinks.linkID)#</cfoutput>" title="Update"><img border="0" name="Update" id="Update" alt="Update" src="../WA_DataAssist/images/Pacifica/Refined_update.gif" /></a></td>
                          <td class="WADADataNavButtonCell" nowrap="nowrap"><a href="tblLinks_Delete.cfm?linkID=<cfoutput>#URLEncodedFormat(WADAtblLinks.linkID)#</cfoutput>" title="Delete"><img border="0" name="Delete" id="Delete" alt="Delete" src="../WA_DataAssist/images/Pacifica/Refined_delete.gif" /></a></td>
                          <td class="WADADataNavButtonCell" nowrap="nowrap"><a href="tblLinks_Results.cfm" title="Results"><img border="0" name="Results" id="Results" alt="Results" src="../WA_DataAssist/images/Pacifica/Refined_results.gif" /></a></td>
                        </tr>
                      </table>
                    </div>
                  </div>
                ...
                <cfif WADAtblLinks.RecordCount EQ 0>
                  ...
                  <div class="WADADetailsLinkArea">
                    <div class="WADADataNavButtonCell"><a href="tblLinks_Results.cfm" title="Results"><img border="0" name="Results1" id="Results1" alt="Results" src="../WA_DataAssist/images/Pacifica/Refined_results.gif" /></a></div>
                  </div>
                  <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                </cfif>
            </div>
