...
<cfif (isDefined("Form.Insert.x")) >
  ...
  <cfset WA_insTable = "news" />
  <cfset WA_sessionName = "WADA_Insert_news" />
  <cfset WA_redirectURL = "news_Detail.cfm" />
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <div class="WADAInsertContainer">
              <cfform action="news_Insert.cfm" method="post" name="WADAInsertForm" id="WADAInsertForm">
                <div class="msgAboveTbl">Search engines read your news too!<br/> When composing subject matter for your news, take care to use words and phrases that will help the search engines guide people to your site. Instead of saying "riding areas" or "the association", say "snowmobile riding areas" or "the Flathead Snowmobile Association". Include words and complete phrases that a person might enter in a search engine.</div>
                <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <th class="WADADataTableHeader">Date:</th>
                    <td class="WADADataTableCell"><cfinput type="datefield" name="newsDate" id="newsDate" value=""  required="yes" message="Date cannot be blank." /><br/><br/><br/></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Headline:</th>
                    <td class="WADADataTableCell"><input type="text" name="newsHeadline" id="newsHeadline" value="" size="32" /></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Details:</th>
                    <td class="WADADataTableCell"><textarea name="newsDetails" cols="50" rows="10" id="newsDetails"></textarea><!--- <input type="text" name="newsDetails" id="newsDetails" value="" size="32" /> ---></td>
                  </tr>
                </table>
                <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
