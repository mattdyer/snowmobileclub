...
<cfparam name="PageNum_WADAofficers" default="1">
<cfquery name="WADAofficers" datasource="FSA1">
SELECT ID, officerPost, FirstName, LastName, telephone, emailAddress FROM officers 
</cfquery>
<cfset MaxRows_WADAofficers=20>
<cfset StartRow_WADAofficers=Min((PageNum_WADAofficers-1)*MaxRows_WADAofficers+1,Max(WADAofficers.RecordCount,1))>
<cfset EndRow_WADAofficers=Min(StartRow_WADAofficers+MaxRows_WADAofficers-1,WADAofficers.RecordCount)>
<cfset TotalPages_WADAofficers=Ceiling(WADAofficers.RecordCount/MaxRows_WADAofficers)>
<cfset QueryString_WADAofficers=Iif(CGI.QUERY_STRING NEQ "",DE("&"&XMLFormat(CGI.QUERY_STRING)),DE(""))>
<cfset tempPos=ListContainsNoCase(QueryString_WADAofficers,"PageNum_WADAofficers=","&")>
<cfif tempPos NEQ 0>
  <cfset QueryString_WADAofficers=ListDeleteAt(QueryString_WADAofficers,tempPos,"&")>
</cfif>
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <div class="WADAResultsContainer"> <a name="top"></a>
              ...
              <cfif WADAofficers.RecordCount GT 0>
                  <div class="WADAResults">
                    <div class="WADAResultsNavigation">
                      <div class="WADAResultsInsertButton"> <a href="officers_Insert.cfm" title="Insert"><img border="0" name="Insert" id="Insert" alt="Insert" src="../WA_DataAssist/images/Pacifica/Refined_insert.gif" /></a> </div>
                    </div>
                    <table class="WADAResultsTable" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <th class="WADAResultsTableHeader">Post:</th>
                        <th class="WADAResultsTableHeader">Name:</th>
                        <th class="WADAResultsTableHeader">Telephone:</th>
                        <th class="WADAResultsTableHeader">Email:</th>
                        <th>&nbsp;</th>
                      </tr>
                      <cfoutput query="WADAofficers" startRow="#StartRow_WADAofficers#" maxRows="#MaxRows_WADAofficers#">
                        <tr class="#WA_AltClassIterator_getClass(WARRT_AltClass1,true)#">
                          <td class="WADAResultsTableCell">#WADAofficers.officerPost#</td>
                          <td class="WADAResultsTableCell">#WADAofficers.FirstName# #WADAofficers.LastName#</td>
                          <td class="WADAResultsTableCell">#WADAofficers.telephone#</td>
                          <td class="WADAResultsTableCell">#WADAofficers.emailAddress#</td>
                          <td class="WADAResultsEditButtons" nowrap="nowrap"><table class="WADAEditButton_Table">
                            <tr>
                              <td><a href="officers_Update.cfm?ID=#URLEncodedFormat(WADAofficers.ID)#" title="Update"><img border="0" name="Update#URLEncodedFormat(WADAofficers.ID)#" id="Update#URLEncodedFormat(WADAofficers.ID)#" alt="Update" src="../WA_DataAssist/images/Pacifica/Refined_edit.gif" /></a></td>
                              <td><a href="officers_Delete.cfm?ID=#URLEncodedFormat(WADAofficers.ID)#" title="Delete"><img border="0" name="Delete#URLEncodedFormat(WADAofficers.ID)#" id="Delete#URLEncodedFormat(WADAofficers.ID)#" alt="Delete" src="../WA_DataAssist/images/Pacifica/Refined_trash.gif" /></a></td>
                            </tr>
                          </table></td>
                        </tr>
                      </cfoutput>
                    ...
                    <div class="WADAResultsNavigation">
                      <div class="WADAResultsNavBottom">
                        <table border="0" cellpadding="0" cellspacing="0" class="WADAResultsNavTable">
                          <tr valign="middle">
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAofficers GT 1>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAofficers=1#QueryString_WADAofficers#</cfoutput>" title="First"><img border="0" name="First1" id="First1" alt="First" src="../WA_DataAssist/images/Pacifica/Refined_first.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAofficers GT 1>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAofficers=#Max(DecrementValue(PageNum_WADAofficers),1)##QueryString_WADAofficers#</cfoutput>" title="Previous"><img border="0" name="Previous1" id="Previous1" alt="Previous" src="../WA_DataAssist/images/Pacifica/Refined_previous.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAofficers LT TotalPages_WADAofficers>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAofficers=#Min(IncrementValue(PageNum_WADAofficers),TotalPages_WADAofficers)##QueryString_WADAofficers#</cfoutput>" title="Next"><img border="0" name="Next1" id="Next1" alt="Next" src="../WA_DataAssist/images/Pacifica/Refined_next.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAofficers LT TotalPages_WADAofficers>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAofficers=#TotalPages_WADAofficers##QueryString_WADAofficers#</cfoutput>" title="Last"><img border="0" name="Last1" id="Last1" alt="Last" src="../WA_DataAssist/images/Pacifica/Refined_last.gif" /></a>
                            </cfif></td>
                          </tr>
                        </table>
                      </div>
                ...
                <cfif WADAofficers.RecordCount EQ 0>
                  <div class="WADANoResults">
                    <div class="WADANoResultsMessage">No results for your search</div>
                    <div> <a href="officers_Insert.cfm" title="Insert"><img border="0" name="Insert1" id="Insert1" alt="Insert" src="../WA_DataAssist/images/Pacifica/Refined_insert.gif" /></a> </div>
                  </div>
                </cfif>
            </div>
