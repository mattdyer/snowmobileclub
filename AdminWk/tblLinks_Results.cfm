...
<cfparam name="PageNum_WADAtblLinks" default="1">
<cfquery name="WADAtblLinks" datasource="FSA1">
SELECT linkID, entryDate, expDate, lastDate, topic, linkURL, linkDesc 
FROM tblLinks 
ORDER BY entryDate DESC
</cfquery>
<cfset MaxRows_WADAtblLinks=20>
<cfset StartRow_WADAtblLinks=Min((PageNum_WADAtblLinks-1)*MaxRows_WADAtblLinks+1,Max(WADAtblLinks.RecordCount,1))>
<cfset EndRow_WADAtblLinks=Min(StartRow_WADAtblLinks+MaxRows_WADAtblLinks-1,WADAtblLinks.RecordCount)>
<cfset TotalPages_WADAtblLinks=Ceiling(WADAtblLinks.RecordCount/MaxRows_WADAtblLinks)>
<cfset QueryString_WADAtblLinks=Iif(CGI.QUERY_STRING NEQ "",DE("&"&XMLFormat(CGI.QUERY_STRING)),DE(""))>
<cfset tempPos=ListContainsNoCase(QueryString_WADAtblLinks,"PageNum_WADAtblLinks=","&")>
<cfif tempPos NEQ 0>
  <cfset QueryString_WADAtblLinks=ListDeleteAt(QueryString_WADAtblLinks,tempPos,"&")>
</cfif>
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <div class="WADAResultsContainer"> <a name="top"></a>
              ...
              <cfif WADAtblLinks.RecordCount GT 0>
                  <div class="WADAResults">
                    <div class="WADAResultsNavigation">
                      <div class="WADAResultsCount">Records
                        <cfoutput>#StartRow_WADAtblLinks#</cfoutput>
                        to
                        <cfoutput>#EndRow_WADAtblLinks#</cfoutput>
                        of
                        <cfoutput>#WADAtblLinks.RecordCount#</cfoutput>
                      </div>
                      <div class="WADAResultsNavTop">
                        <table border="0" cellpadding="0" cellspacing="0" class="WADAResultsNavTable">
                          <tr valign="middle">
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblLinks GT 1>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblLinks=1#QueryString_WADAtblLinks#</cfoutput>" title="First"><img border="0" name="First" id="First" alt="First" src="../WA_DataAssist/images/Pacifica/Refined_first.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblLinks GT 1>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblLinks=#Max(DecrementValue(PageNum_WADAtblLinks),1)##QueryString_WADAtblLinks#</cfoutput>" title="Previous"><img border="0" name="Previous" id="Previous" alt="Previous" src="../WA_DataAssist/images/Pacifica/Refined_previous.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblLinks LT TotalPages_WADAtblLinks>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblLinks=#Min(IncrementValue(PageNum_WADAtblLinks),TotalPages_WADAtblLinks)##QueryString_WADAtblLinks#</cfoutput>" title="Next"><img border="0" name="Next" id="Next" alt="Next" src="../WA_DataAssist/images/Pacifica/Refined_next.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblLinks LT TotalPages_WADAtblLinks>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblLinks=#TotalPages_WADAtblLinks##QueryString_WADAtblLinks#</cfoutput>" title="Last"><img border="0" name="Last" id="Last" alt="Last" src="../WA_DataAssist/images/Pacifica/Refined_last.gif" /></a>
                            </cfif></td>
                          </tr>
                        </table>
                      </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="WADAResultsTable">
                      ...
                      <cfoutput query="WADAtblLinks" startRow="#StartRow_WADAtblLinks#" maxRows="#MaxRows_WADAtblLinks#">
                        <tr class="#WA_AltClassIterator_getClass(WARRT_AltClass1,true)#">
                          <td class="WADAResultsTableCell">#Dateformat(WADAtblLinks.entryDate,"MM/DD/YYYY")#</td>
                          <td class="WADAResultsTableCell">#Dateformat(WADAtblLinks.expDate,"MM/DD/YYYY")#</td>
                          <td class="WADAResultsTableCell">#Dateformat(WADAtblLinks.lastDate,"MM/DD/YYYY")#</td>
                          <td class="WADAResultsTableCell"><a href="tblLinks_Detail.cfm?linkID=#URLEncodedFormat(WADAtblLinks.linkID)#" >#WADAtblLinks.topic#</a></td>
                          <td width="130" class="WADAResultsTableCell"><a href="#WADAtblLinks.linkURL#">
                          <span title="#WADAtblLinks.linkURL#">Point Here to see the link. Click to go to it.</span></a></td>
                          <td class="WADAResultsTableCell">#WADAtblLinks.linkDesc#</td>
                          <td class="WADAResultsEditButtons" nowrap="nowrap"><table class="WADAEditButton_Table">
                            <tr>
                              <td><a href="tblLinks_Detail.cfm?linkID=#URLEncodedFormat(WADAtblLinks.linkID)#" title="View"><img border="0" name="View#URLEncodedFormat(WADAtblLinks.linkID)#" id="View#URLEncodedFormat(WADAtblLinks.linkID)#" alt="View" src="../WA_DataAssist/images/Pacifica/Refined_zoom.gif" /></a></td>
                              <td><a href="tblLinks_Update.cfm?linkID=#URLEncodedFormat(WADAtblLinks.linkID)#" title="Update"><img border="0" name="Update#URLEncodedFormat(WADAtblLinks.linkID)#" id="Update#URLEncodedFormat(WADAtblLinks.linkID)#" alt="Update" src="../WA_DataAssist/images/Pacifica/Refined_edit.gif" /></a></td>
                              <td><a href="tblLinks_Delete.cfm?linkID=#URLEncodedFormat(WADAtblLinks.linkID)#" title="Delete"><img border="0" name="Delete#URLEncodedFormat(WADAtblLinks.linkID)#" id="Delete#URLEncodedFormat(WADAtblLinks.linkID)#" alt="Delete" src="../WA_DataAssist/images/Pacifica/Refined_trash.gif" /></a></td>
                            </tr>
                          </table></td>
                        </tr>
                      </cfoutput>
                    ...
                    <div class="WADAResultsNavigation">
                      ...
                      <div class="WADAResultsNavBottom">
                        <table border="0" cellpadding="0" cellspacing="0" class="WADAResultsNavTable">
                          <tr valign="middle">
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblLinks GT 1>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblLinks=1#QueryString_WADAtblLinks#</cfoutput>" title="First"><img border="0" name="First1" id="First1" alt="First" src="../WA_DataAssist/images/Pacifica/Refined_first.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblLinks GT 1>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblLinks=#Max(DecrementValue(PageNum_WADAtblLinks),1)##QueryString_WADAtblLinks#</cfoutput>" title="Previous"><img border="0" name="Previous1" id="Previous1" alt="Previous" src="../WA_DataAssist/images/Pacifica/Refined_previous.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblLinks LT TotalPages_WADAtblLinks>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblLinks=#Min(IncrementValue(PageNum_WADAtblLinks),TotalPages_WADAtblLinks)##QueryString_WADAtblLinks#</cfoutput>" title="Next"><img border="0" name="Next1" id="Next1" alt="Next" src="../WA_DataAssist/images/Pacifica/Refined_next.gif" /></a>
                            </cfif></td>
                            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><cfif PageNum_WADAtblLinks LT TotalPages_WADAtblLinks>
                              <a href="<cfoutput>#CurrentPage#?PageNum_WADAtblLinks=#TotalPages_WADAtblLinks##QueryString_WADAtblLinks#</cfoutput>" title="Last"><img border="0" name="Last1" id="Last1" alt="Last" src="../WA_DataAssist/images/Pacifica/Refined_last.gif" /></a>
                            </cfif></td>
                          </tr>
                        </table>
                      </div>
                ...
                <cfif WADAtblLinks.RecordCount EQ 0>
