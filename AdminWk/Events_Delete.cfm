...
SELECT ID, eventName, eventDate, eventTime, eventLocation FROM Events WHERE ID = <cfqueryparam value="#URL.ID#" cfsqltype="cf_sql_numeric"> 
</cfquery>
...
<!-- #EndLibraryItem --><!--========================= STOP COPYING THE HTML HERE =========================-->
  ...
  <div id="mainContent"> <!-- InstanceBeginEditable name="Heading1" --><h1>Delete Events</h1><!-- InstanceEndEditable -->
      <div id="MainImg">
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <div class="WADADeleteContainer">
            <cfif WADAEvents.RecordCount GT 0><form action="Events_Delete.cfm?ID=<cfoutput>#URLEncodedFormat(WADAEvents.ID)#</cfoutput>" method="post" name="WADADeleteForm" id="WADADeleteForm"><div class="WADAHeader"></div>
                ...
                <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td class="WADADataTableCell"><cfoutput>#WADAEvents.eventName#</cfoutput></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Date:</th>
                    <td class="WADADataTableCell"><cfoutput>#Dateformat(WADAEvents.eventDate,"MM/DD/YYYY")#</cfoutput></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Time:</th>
                    <td class="WADADataTableCell"><cfoutput>#WADAEvents.eventTime#</cfoutput></td>
                  </tr>
                  <tr>
                    <th class="WADADataTableHeader">Location:</th>
                    <td class="WADADataTableCell"><cfoutput>#WADAEvents.eventLocation#</cfoutput></td>
                  </tr>
                </table>
                <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                <div class="WADAButtonRow">
                  ...
                  <input name="WADADeleteRecordID" type="hidden" id="WADADeleteRecordID" value="<cfoutput>#URLEncodedFormat(WADAEvents.ID)#</cfoutput>" />
                </div>
              </form>
            </cfif>
