...
<cfinclude template="../WA_DataAssist/WA_AppBuilder_CF.cfm"><cfparam name="URL.AdsID" default="-1">
<cfquery name="WADAtblAds" datasource="FSA1">
SELECT AdsID, AdsCustomerName, AdsHeadline, AdsBody, AdsLink, AdsBanner, AdsStartDate, AdsEndDate 
FROM tblAds 
WHERE AdsID = <cfqueryparam value="#URL.AdsID#" cfsqltype="cf_sql_numeric"> 
</cfquery>
<cfif (isDefined("Form.Delete.x")) >
  <cfset WA_connection = "FSA1" />
  <cfset WA_table = "tblAds" />
  <cfset WA_redirectURL = "tblAds_Results.cfm" />
  <cfset WA_keepQueryString = false >
  <cfset WA_indexField = "AdsID" />
          ...
          <tr>
            ...
            <div class="WADADeleteContainer">
              <cfif WADAtblAds.RecordCount GT 0>
                <form action="tblAds_Delete.cfm?AdsID=<cfoutput>#URLEncodedFormat(WADAtblAds.AdsID)#</cfoutput>" method="post" name="WADADeleteForm" id="WADADeleteForm">
                  ...
                  <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      ...
                      <td class="WADADataTableCell"><cfoutput>#WADAtblAds.AdsCustomerName#</cfoutput></td>
                    </tr>
                    <tr>
                      <th class="WADADataTableHeader">Ad Headline:</th>
                      <td class="WADADataTableCell"><cfoutput>#WADAtblAds.AdsHeadline#</cfoutput></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="WADADataTableCell"><cfoutput>#WADAtblAds.AdsLink#</cfoutput></td>
                    </tr>
                    <tr>
                      <th class="WADADataTableHeader">Ad Banner:</th>
                      <td class="WADADataTableCell"><cfoutput>#WADAtblAds.AdsBanner#</cfoutput></td>
                    </tr>
                    <tr>
                  ...
                  <div class="WADAButtonRow">
                    ...
                    <input name="WADADeleteRecordID" type="hidden" id="WADADeleteRecordID" value="<cfoutput>#URLEncodedFormat(WADAtblAds.AdsID)#</cfoutput>" />
                  </div>
                </form>
              </cfif>
