...
<cfif (isDefined("Form.Insert.x")) >
  ...
  <cfset WA_insTable = "officers" />
  <cfset WA_sessionName = "WADA_Insert_officers" />
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <div class="WADAInsertContainer">
              <form action="officers_Insert.cfm" method="post" name="WADAInsertForm" id="WADAInsertForm">
                <div class="WADAHeader"></div>
                <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
                <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <th class="WADADataTableHeader">Post:</th>
                    <td class="WADADataTableCell"><input type="text" name="officerPost" id="officerPost" value="" size="32" /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="WADADataTableCell"><input type="text" name="telephone" id="telephone" value="" size="32" /></td>
                  </tr>
                  <tr>
