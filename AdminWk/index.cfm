<cfset newsPath=ExpandPath("../newsletter/")>
...
<title>FSA Administration</title>
<!-- InstanceEndEditable -->
...
<!-- #EndLibraryItem --><!--========================= STOP COPYING THE HTML HERE =========================-->
  ...
  <div id="mainContent"> <!-- InstanceBeginEditable name="Heading1" -->
    <h1>Administration</h1><!-- InstanceEndEditable -->
      <div id="MainImg">
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><!-- InstanceBeginEditable name="MainText" -->
              ...
              <div align="center">
                <p><a href="Users_Results.cfm">Users</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="officers_Results.cfm">Officers</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="Events_Results.cfm">Events</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="news_Results.cfm">News</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="tblLinks_Results.cfm">Links</a></p>
                <p><a href="tblAds_Results.cfm">Local Services Ads</a></p>
                <p>&nbsp;</p>
              <!--- If a PDF was selected for upload--->
                  <cfif IsDefined("FORM.News1") AND #FORM.News1# NEQ "">
                    <!--- Replace all of the blank spaces in the filename with underscores
                    <cfset FORM.News1 = Replace("#FORM.News1#"," ","_","ALL")> --->
                    <!--- Upload the PDF to the news folder and rename it--->
                    <cffile  action="upload" destination="#newsPath#\news.pdf" filefield="News1" nameconflict="overwrite" accept="application/pdf, application/x-octet-stream" >
                    
                    <!--- Assign the uploaded filename to a variable--->
                    <cfset Filename_News1 = "#CFFILE.ServerFile#">
       		    </cfif>              
                <cfform name="upNews" id="upNews" method="post" action="index.cfm" enctype="multipart/form-data" >
                  Upload Newsletter (PDF Only)
                  <cfinput type="file" name="News1" size="32" accept="application/pdf"/>
                  <cfinput type="submit" name="submit" value="Upload">
                </cfform>
                <p class="footerCtr">Click here for <a href="../newsletter/news.pdf" >current newletter</a></p>
                <!--- <p><a href="http://mail.flatheadsnowmobiler.com">email</a></p> --->
              </div>
              <p>&nbsp;</p><p>&nbsp;</p>
